<?php
//=========التوكن=========//
$token = "6055684956:AAEZhofjjKzniBczaC5WRPgtJL2beVlq9R8"; 
...
#############
$admin = "1279427042";
$Dev = array("$admin","1279427042");
$eri = array("$admin","1279427042");
$idbot = "6055684956";
$sudo = "$admin";
$buy = "u_5_r";
$DevUser = "@$buy";
...
⋄︙ [تحديثات السورس الجديده](https://t.me/u_5_t)",
'parse_mode'=>"markdown",
...
[['text'=>'⋄ الغاء ⋄' ,'callback_data'=>"deletmil"]],
[['text'=>"⋄ قناة السورس ⋄",'url'=>"t.me/u_5_t"]],
]])
]); 
}
}
...
⋄︙[تعليمات الامر (مهم)](https://t.me/ii)
",'parse_mode'=>"MARKDOWN",
 'reply_to_message_id'=>$message_id
,]);}
...
⋄︙[تعليمات الامر (مهم)](https://t.me/u_5_t)
",'parse_mode'=>"MARKDOWN",
 'reply_to_message_id'=>$message_id
,]);}
...
'reply_to_message_id'=>$message_id,
'reply_markup'=>json_encode([
'inline_keyboard'=>[[['text'=>"- CaRloS .",'url'=>"t.me/u_5_t"]],]])]);}}
#┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
$re = $update->message->reply_to_message;
...
########
if($text == "⋄ تجربة السورس"){if(in_array($from_id,$Dev) or in_array($from_id,$eri)) {bot("sendmessage",['chat_id'=>$chat_id,'text'=>"✵⁞ *اليك قائمة تجربة السورس*\n━━━━━━━━━━━━━\n⌯⁞ [كروب تجربة السورس](https://t.me/THBBS)\n⌯⁞ [قناة شروحات السورس](https://t.me/TH3SS)\n━━━━━━━━━━━━━\n⌯⁞ [مطور السورس](https://t.me/u_5_r)",'parse_mode'=>"Markdown",'disable_web_page_preview'=> true ,'reply_to_message_id'=>$message_id,'reply_markup'=>json_encode(['inline_keyboard'=>[[['text'=>"⌯⁞ كروب تجربة السورس ⁞⌯",'url'=>"t.me/thbbs"]],[['text'=>"⌯⁞ مطور السورس ⁞⌯",'url'=>"t.me/$buy"]],]])]);}}
#######
